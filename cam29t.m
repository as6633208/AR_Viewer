...
%Cam_R = ipcam('http://192.168.0.198/mjpg/video.mjpg','root','0000','Timeout',20);
%cam_R=videoinput('winvideo',2);


% Capture one frame to get its size.
img1 = imread('C:\opencv\123\imgFromCamL_2.png');
frameSize1 = size(img1); 
img2 = imread('C:\opencv\123\imgFromCamR_2.png');
frameSize2 = size(img2); 
...
object1 = insertShape(imgGray1, 'Rectangle', objectRegion, 'LineWidth',4,'Color','red');
